...
import { OrderComponent2 } from './components/moderator/order/order.component';
...
import { DatbanComponent } from './components/client/datban/datban.component';
import { QuanlydatbanComponent } from './components/admin/quanlydatban/quanlydatban.component';
...
const routes: Routes = [
  ...
  },
  {
    ...
    children:[
      ...
      {path:'order',component:OrderComponent2},
      {path:'status-order',component:StatusorderComponent},
      {path:'chitiet/:id',component:ChitietComponent},
