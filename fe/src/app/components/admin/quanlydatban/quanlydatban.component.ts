...
@Component({
  selector: 'app-quanlydatban',
  templateUrl: './quanlydatban.component.html',
  styleUrls: ['./quanlydatban.component.css'],
  providers: [MessageService]
})
export class QuanlydatbanComponent implements OnInit {
  ...
  showUpdate(data: any){
    ...
    this.blogForm.nguoilon = data.nguoilon;
    this.blogForm.treem = data.treem;
    this.blogForm.ngayden = data.ngayDen;
    this.blogForm.gioden = data.gioden;
    this.blogForm.gmail = data.gmail;
    this.blogForm.sdt = data.sdt;
    this.blogForm.ten = data.ten;
    this.blogForm.ghichu = data.ghichu;
  ...
  getList(){
    this.datBanService.getList().subscribe({
      next: res =>{
        this.listBlog =res;
      },error: err =>{
        console.log(err);
  ...
  updateBlog(){
    const {id,nguoilon,treem,ngayden,gioden,gmail,sdt,ten,ghichu} = this.blogForm;
   
    this.datBanService.updateDatban(id,nguoilon,treem,ngayden,gioden,gmail,sdt,ten,ghichu).subscribe({
      next: res =>{
        this.getList();
        this.showForm=false;
  ...
  deleteBlog(){
    this.datBanService.deleleDatban(this.blogForm.id).subscribe({
      next: res =>{
        this.getList();
        this.onDelete = false;
